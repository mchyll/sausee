...
export type AppAction = IncrementCounterAction | DecrementCounterAction | CreateTripAction | CreateObservationAction | SetObservationCoordinatesAction | FinishObservationAction | FinishTripAction | AddRoutePathCoordinatesAction;
